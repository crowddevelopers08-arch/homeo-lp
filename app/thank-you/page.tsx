  ...
  return (
    <div className="flex flex-col bg-[#000d44] font-sans text-white">
      ...
      <main className="relative flex flex-1 items-center justify-center overflow-hidden px-6 py-8">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1020px] text-center">
          ...
          <p className="mt-5 text-[16px] leading-7 font-medium text-white/85">
            Your appointment request has been received. Your consultation details will be shared with you on WhatsApp shortly.
          </p>
          ...
          <div className="relative mt-8 overflow-hidden rounded-2xl border border-[#1f5fff]/60 bg-[linear-gradient(105deg,rgba(31,95,255,.2),rgba(255,255,255,.06))] px-6 py-6 text-left shadow-[0_12px_35px_rgba(0,0,0,.18)]">
            ...
            <ul className="mt-4 space-y-3 text-[14.5px] leading-6 font-semibold text-white/90">
              ...
              <li className="flex gap-3">
                ...
                <span>A B Homeo doctor will call you at the scheduled time to discuss your child's concerns.</span>
              </li>
              <li className="flex gap-3">
                <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-full bg-[#1f5fff] text-[12px] font-extrabold">3</span>
                <span>Prescribed medicines, if any, can be delivered to your home within the service area.</span>
              </li>
            </ul>
          </div>
