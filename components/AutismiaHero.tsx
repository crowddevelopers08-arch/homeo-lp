...
export default function AutismiaHero() {
  return <section className="relative min-h-[900px] overflow-hidden bg-[#000d44] font-sans text-white lg:min-h-screen">
    ...
    <header className="relative z-30 mx-auto flex h-[90px] max-w-[1380px] items-center justify-between px-6">
      ...
      <a href="#contact" className="group relative hidden rounded-xl bg-[#1f5fff] px-7 py-3.5 text-[14px] font-semibold shadow-lg shadow-black/10 md:block">
      ...
      <button aria-label="Open menu" className="grid gap-1.5 md:hidden"><span className="h-0.5 w-7 bg-white"/><span className="h-0.5 w-7 bg-white"/><span className="h-0.5 w-7 bg-white"/></button>
    </header>
    ...
    <div className="relative z-10 mx-auto grid max-w-[1380px] grid-cols-1 items-start gap-0 px-6 pb-16 pt-2 md:pt-20 lg:grid-cols-[1.05fr_.95fr] lg:gap-12 lg:pt-10">
      <div className="contents relative z-20 max-w-[660px] lg:block lg:pt-8">
        ...
        <a href="#" className="order-6 group relative mt-6 inline-flex justify-self-start rounded-[10px] bg-[#1f5fff] px-7 py-3.5 text-[14px] font-semibold shadow-lg shadow-black/10 transition-opacity hover:opacity-90">
