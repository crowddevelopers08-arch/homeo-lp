    ...
    <section className="relative min-h-[690px] overflow-hidden bg-[#000d44] font-sans">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 py-16 md:px-14">
        <div className="max-w-[700px]">
          ...
          <a href="#contact" className="group relative mt-9 inline-flex rounded-[10px] bg-[#1f5fff] px-7 py-3.5 text-[14px] font-semibold text-white shadow-lg shadow-black/10 transition-opacity hover:opacity-90">
