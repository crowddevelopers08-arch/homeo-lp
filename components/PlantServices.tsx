...
const services = [
  ...
  {
    title: "2. Expect a Doctor’s Call on Your Mobile Soon!",
    description: "A B Homeo doctor will connect with you at the scheduled time and discuss your child’s concerns, symptoms and care needs.",
    alt: "B Homeo doctor speaking with a parent by phone",
    position: "-left-full",
  },
  {
    title: "3. Fast Home Delivery",
    description: "Prescribed homeopathic medicines can be delivered to your home within the available service area. Delivery charges extra. COD available.",
    ...
    <section id="services" className="min-h-[835px] overflow-hidden bg-white font-sans">
      ...
      <div className="min-h-[550px] bg-[linear-gradient(to_bottom,#1f5fff_0px,#1f5fff_363px,#fff_363px,#fff_100%)] max-sm:px-0 px-6 pt-[100px]">
        ...
        <div className="mx-auto flex max-w-[1320px] justify-center max-sm:pb-0 py-10">
          <a href="#" className="group relative inline-flex rounded-[10px] bg-[#1f5fff] px-8 py-3.5 text-[14px] font-semibold text-white shadow-lg shadow-[#1f5fff]/20 transition-opacity hover:opacity-90">
