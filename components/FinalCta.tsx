  ...
  return (
    <section className="overflow-hidden bg-white py-8 font-sans lg:py-10">
      <div className="relative mx-auto w-full overflow-hidden bg-[#000d44] lg:grid lg:min-h-[430px] lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="relative z-10 hidden flex-col items-start justify-center px-7 py-12 text-white sm:px-12 lg:flex lg:px-16 lg:py-14">
          ...
          <a href="#" className="group relative mt-8 inline-flex rounded-[10px] bg-[#1f5fff] px-8 py-3.5 text-[14px] font-semibold text-white shadow-lg shadow-[#1f5fff]/20 transition-opacity hover:opacity-90">
        ...
        <div className="relative hidden min-h-[360px] lg:block lg:min-h-full">
          ...
          <div className="absolute inset-5 overflow-hidden rounded-[24px] sm:inset-7 lg:bottom-0 lg:left-8 lg:right-0 lg:top-0 lg:rounded-l-[45%] lg:rounded-r-none">
            <Image src="/adhd-faq-doctor-child.png" alt="B Homeo doctor supporting a child during a consultation" fill sizes="(max-width: 1024px) 100vw, 620px" quality={95} className="object-cover object-center" />
        ...
        <div className="relative z-10 px-7 py-12 text-white sm:px-12 lg:hidden">
          ...
          <div className="relative mt-7 aspect-[4/3] w-full overflow-hidden rounded-[24px] sm:aspect-[16/9]">
            <Image src="/adhd-faq-doctor-child.png" alt="B Homeo doctor supporting a child during a consultation" fill sizes="100vw" quality={95} className="object-cover object-center" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#000d44]/35 via-transparent to-transparent" />
          </div>

          <a href="#" className="group relative mt-7 inline-flex rounded-[10px] bg-[#1f5fff] px-8 py-3.5 text-[14px] font-semibold text-white shadow-lg shadow-[#1f5fff]/20 transition-opacity hover:opacity-90">
            <svg className="pointer-events-none absolute inset-0 h-full w-full overflow-visible" aria-hidden="true">
              <rect x="7" y="7" rx="7" fill="none" stroke="white" strokeWidth="2" strokeDasharray="10 7" className="button-running-dash" style={{ width: "calc(100% - 14px)", height: "calc(100% - 14px)" }} />
            </svg>
            <span className="relative z-10">Start with a Consultation</span>
